      ...
      <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 p-10 rounded-lg z-10 backdrop-blur-sm bg-white/5 border border-solid border-white">
        <div className="text-center text-[#001E01]">
          ...
          <div>
            <Link
              href="/login"
              className="bg-[#D8DFFF] text-[#001E01] p-3 rounded-lg hover:bg-[#b3ffe8] transition-all duration-300 ease-in-out"
            >
              Login
            </Link>
            <Link
              href="/signup"
              className="ml-4 bg-transparent text-[#001E01] p-3 border-2 border-[#001E01] rounded-lg hover:bg-[#b3ffe8] hover:text-[#1c5a1e] transition-all duration-300 ease-in-out"
            >
              Sign Up
            </Link>
          </div>
