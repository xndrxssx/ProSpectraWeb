...
C:\Qt\Tools\mingw530_32\bin\ar rs libdlpspec.a dlpspec.o dlpspec_scan.o dlpspec_calib.o dlpspec_util.o tpl.o mmap.o dlpspec_scan_had.o dlpspec_scan_col.o dlpspec_helper.o
del *.o
